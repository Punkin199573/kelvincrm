...
import { Crown, Shield, AlertTriangle, Loader2 } from "lucide-react"
...
export function AdminProtection({ children }: AdminProtectionProps) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardContent className="flex flex-col items-center justify-center p-8">
            <Loader2 className="h-12 w-12 animate-spin text-electric-500 dark:text-ice-500 mb-4" />
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center p-4">
        <Card className="w-full max-w-md border-electric-500/20 dark:border-ice-500/20">
          <CardHeader className="text-center">
            <Shield className="h-12 w-12 mx-auto mb-4 text-electric-500 dark:text-ice-500" />
            <CardTitle className="text-electric-600 dark:text-ice-400">Authentication Required</CardTitle>
  ...
  return (
    <div className="min-h-screen">
      <div className="bg-gradient-to-r from-electric-500/10 to-purple-500/10 dark:from-ice-500/10 dark:to-purple-500/10 border-b">
