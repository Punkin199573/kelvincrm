-- Script to fix RLS policies and update admin credentials
...
-- Note: You'll need to set the password manually in Supabase Auth dashboard
-- or use the Supabase CLI/API to create the user with password 'Benefitpay'
